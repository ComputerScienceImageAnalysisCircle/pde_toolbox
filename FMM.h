...
void RIE_INT_destructor(RIE_INT * thisa);
RIE_FLOAT * RIE_FLOAT_constructor(void);
void RIE_FLOAT_destructor(RIE_FLOAT * thisa);
RIE_SURF * RIE_SURF_constructor(void);
void RIE_SURF_destructor(RIE_SURF * thisa);
int RIE_INT_add(int dx, int dy, char restrict_to_surface, RIE_SURF * rie_surf, RIE_INT * thisa);
int RIE_FLOAT_add(float dx, float dy, char restrict_to_surface, RIE_SURF * rie_surf, RIE_FLOAT * thisa);
int RIE_INT_to_index(RIE_INT * thisa, RIE_SURF * rie_surf);
int index_to_RIE_INT(int index, RIE_INT * coord, RIE_SURF * rie_surf);
char RIE_INT_on_surface(RIE_INT * thisa, RIE_SURF * rie_surf);
char RIE_FLOAT_on_surface(RIE_FLOAT * thisa, RIE_SURF * rie_surf);
